  ...
  public static void extraPayFirstMonth(Loan l, double extraPay) {
	//variable declaration
	  ...
	  while (myLoanAmount >= myMonthlyPayment) {
		interest = (1+myMonthlyInterestRate)*myLoanAmount - myLoanAmount;
		principal  
		myLoanAmount = (principal)*[(1+myMonthlyInterestRate)-myMonthlyPayment]^month;
		totalInterest += (principal)*[(1+myMonthlyInterestRate)-myMonthlyPayment]^month;
		month++;}

	  if (myLoanAmount < myMonthlyPayment) {
		  myMonthlyPayment = myLoanAmount;}
